...
p {
   ...
   <body>
    ...
    <img src="{{$order->image}}" alt="" height="auto" width="100%">
            <h2 style="background-color: #4CAF50;
    color: #fff;
    padding: 10px;
    border-radius: 0 0 8px 8px;">Product:{{$order->product_title}}</h2>
            
            <p>Quantity: {{$order->quantity}}</p>
            <p style="background-color:black; margin-top: 5px;
    color: #4CAF50;
    font-weight: bold;">Price: ${{$order->price}}</p>
